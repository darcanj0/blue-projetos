...
while (true) {
  rep1 = prompt(
    "Você reporta a mensagem ao seu chefe?(sim/nao)   "
  ).toLowerCase();
  if (rep1 == "sim" || rep1 == "nao") {
    break;
  } else {
    console.log("Digite uma resposta válida (sim/nao).");
  }
}
...
//segunda pergunta
console.log(
  "Na manhã seguinte, você está tomando seu café da manhâ em sua casa."
);
console.log();
...
while (true) {
  rep2 = prompt(
    "Você liga a televisão, para ver o noticiário?(sim/nao)   "
  ).toLowerCase();
  if (rep2 == "sim" || rep2 == "nao") {
    break;
  } else {
    console.log("Digite uma resposta válida (sim/nao).");
  }
...
//terceira pergunta
console.log(
  "Você sai um pouco atrasado para o trabalho e perde o ônibus. Por sorte, um amigo passa e te oferece carona."
);
console.log();
...
while (true) {
  rep3 = prompt(
    "Você aceita a carona e vai ao trabalho, ao invés de voltar pra casa?(sim/nao)   "
  ).toLowerCase();
  if (rep3 == "sim" || rep3 == "nao") {
    break;
  } else {
    console.log("Digite uma resposta válida (sim/nao).");
  }
...
//quarta pergunta
console.log(
  "Dois dias depois, enquanto você está no trabalho, sua cidade é invadida pelos Tuks. O prédio onde vc trabalha está sendo atacado."
);
console.log();
...
while (true) {
  rep4 = prompt(
    "Um tuk entra e começa a bater nas pessoas. Você enfrenta o Tuk?(sim/nao)   "
  ).toLowerCase();
  if (rep4 == "sim" || rep4 == "nao") {
    break;
  } else {
    console.log("Digite uma resposta válida (sim/nao).");
  }
...
// quinta pergunta
console.log(
  "Alguns minutos mais tarde, você recebe uma ligação. É um Tuk que diz que sequestrou sua família e está mantendo eles como reféns em sua casa."
);
console.log();
...
while (true) {
  rep5 = prompt(
    "Você volta à sua casa, para tentar impedir o Tuk?(sim/nao)   "
  ).toLowerCase();
  if (rep5 == "sim" || rep5 == "nao") {
    break;
  } else {
    console.log("Digite uma resposta válida (sim/nao).");
  }
...
if (conta_sims == 5) {
  ...
  console.log(
    `Você é bem preguiçoso pelo jeito. Sua atitude pode até ter evitado situações piores, mas dá pra ver que sua situação não é boa`
  );
} else {
